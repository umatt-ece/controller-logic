...
/*!
    ...
    \brief Provides an implementation of the ease_out_sine easing function. For more information on
...
/*******************************************************************************/
/*!
    \brief Easing function that starts slow and speeds up a visualization of the function
    can be found at https://easings.net/#easeOutCubic.

...
/*!
    ...
    \brief Provides a basic interface for working with easing functions. For more information on
...
/*******************************************************************************/
/*!
    \brief EasingStrategy is a function pointer that takes in an integer time and duration and returns a double.
    The time and duration are used to calculate the current progress of the easing function. The return value
    should be in the range [0, 1] where 0 is the start of the easing function and 1 is the end of the easing
    function.
